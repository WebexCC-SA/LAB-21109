...
# Mission 4: Configure Transfer Action for a Specific Queue
...
3. (<span style="color: red;"><strong>Read Only</strong></span>) In the previous task, we created an action with the **department** entity. The information about the value of the entity can be retrieved from the Activity Output Variable, specifically from **VirtualAgentV2XXXMetaData**.
...
10. (<span style="color: red;"><strong>Read Only</strong></span>) From MetaData we can see the value of the department entity is "HR".
